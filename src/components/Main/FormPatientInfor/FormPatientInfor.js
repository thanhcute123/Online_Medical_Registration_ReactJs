    ...
    return(
        <div className="shadow-sm d-flex justify-content-center flex-column w-100 pb-5">
            ...
            <div className="row sub_form mt-2">
                <div className="col-sm-12 col-lg-6 col-md-12">
                    <div className="w-95 ml-3">
                        <p>Họ và tên <span className="text-danger">*</span></p>
                        <div className="d-flex justify-content-center align-items-center w-100">
                            <form className="w-100">
                                <div className="form-group">
                                    <input value={formData.name} onChange={handleNameChange} className="form-control text-button" type="text" placeholder="Nhập họ tên"/>
                ...
                <div className="col-sm-12 col-lg-6 col-md-12">
                    <div className="w-95">
                        <p className="margin">Ngày sinh <span className="text-danger">*</span></p>
                        <div className="d-flex justify-content-center align-items-center w-100 margin">
                            <form className="w-100">
                                <div className="form-group">
                                    <input value={formData.dateOfBirth} onChange={handleDateOfBirthChange} className="form-control text-button" type="date"/>
            ...
            <div className="sub_form row">
                <div className="col-sm-12 col-lg-6 col-md-12">
                    <div className="w-95 ml-3">
                        ...
                        <div className="d-flex justify-content-center align-items-center w-100">
                            <form className="w-100">
                                <div className="form-group">
                                    <input value={formData.numberPhone} onChange={handlePhoneChange} className="form-control text-button" type="text" placeholder="Nhập số điện thoại"/>
                ...
                <div className="col-sm-12 col-lg-6 col-md-12">
                    <div className="w-95">
                        <p className="margin">Giới tính <span className="text-danger">*</span></p>
                        <div className="d-flex justify-content-center align-items-center w-100 margin">
                            <form className="w-100">
                                <div className="form-group">
                                    <select value={formData.gender} onChange={handleChangeOptionGender} className="form-control text-button" id="exampleFormControlSelect1">
            ...
            <div className="w-100 mt-none ml-3 mt-2">
                <p>Địa chỉ <span className="text-danger">*</span></p>
                <div className="d-flex justify-content-center align-items-center w-95">
                    <form className="w-100">
                        <div className="form-group">
                            <input value={formData.address} onChange={handleAddressChange} className="form-control text-button" type="text" placeholder="Nhập địa chỉ"/>
            ...
            <div className="row justify-content-center main mt-3">
                <button onClick={prePage} className="col-sm-4 bg-color btn p-2 text-button border-success bt mr-2 margin">
                    Quay lại
                </button>
                <button onClick={handleFormPatientInforSubmit} className="col-sm-4 btn bg-color-active p-2 text-button bt margin text-white">
                    Đăng ký khám
                </button>
            </div>
